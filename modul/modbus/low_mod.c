...
void taruh_data_710(int no_slave, int urt)	{
	...
	if (urt == 0)  {   //satuan2
		...
		asli_PM710[no_slave].kva = (signed) data_PM710[no_slave].kva * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kw  == 32768)
			...
			asli_PM710[no_slave].kw = (signed) data_PM710[no_slave].kw * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kwA  == 32768)
			...
			asli_PM710[no_slave].kwA = (signed) data_PM710[no_slave].kwA * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kwB  == 32768)
			...
			asli_PM710[no_slave].kwB = (signed) data_PM710[no_slave].kwB * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kwC  == 32768)
			...
			asli_PM710[no_slave].kwC = (signed) data_PM710[no_slave].kwC * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvaA  == 32768)
			...
			asli_PM710[no_slave].kvaA =(signed)  data_PM710[no_slave].kvaA * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvaB  == 32768)
			...
			asli_PM710[no_slave].kvaB = (signed) data_PM710[no_slave].kvaB * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvaC  == 32768)
			...
			asli_PM710[no_slave].kvaC = (signed) data_PM710[no_slave].kvaC * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvarA  == 32768)
			...
			asli_PM710[no_slave].kvarA = (signed) data_PM710[no_slave].kvarA * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvarB  == 32768)
			...
			asli_PM710[no_slave].kvarB = (signed) data_PM710[no_slave].kvarB * satuan_kw[no_slave];
		...
		if (data_PM710[no_slave].kvarC  == 32768)
			...
			asli_PM710[no_slave].kvarC = (signed) data_PM710[no_slave].kvarC * satuan_kw[no_slave];
		//urut_PM710 = 5;
	}
/*
	else if (urt == 5)
...
//*/
	...
	void taruh_data_810(int pm_dibaca, int urt) {
		...
		{	//xx voltA_B, B_C, A_C, A_N, B_N & C_N
			...
			data_PM710[pm_dibaca].kw = (signed short) (data_PM710[pm_dibaca].kw << 8) + buf[10+HD];
			if (data_PM710[pm_dibaca].kw == 32768)
				asli_PM710[pm_dibaca].kw = 0;
			else
				asli_PM710[pm_dibaca].kw =(short)  data_PM710[pm_dibaca].kw * satuan_kw[pm_dibaca];
			#ifdef CEK_PM
...
{	
	...
	else if(urut==1)
	{
		...
		for(i=0;i<4;i++)
		{
			...
			temp3=(temp1<<16) + temp2;
			ftemp=5*((float) temp3)/1000; //harusnya di scaled dengan data CT 
									//Untuk CT 100/5 -> 1000
									//Untuk CD 200/5 -> 500
	...
	else if(urut==3)
	{
		...
		#ifdef LIAT
		printf(">Power Factor \n");
		printf(" - Address 3%0.4d: (0x%0.4X) =>  %d => %0.3f\n",meter_power_micom+i*2, temp1, temp1, ftemp);
		#endif
